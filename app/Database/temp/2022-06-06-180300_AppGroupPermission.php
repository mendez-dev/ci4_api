...
class AppGroupPermission extends Migration
{
    protected $table_name = "app_group_permission";
    ...
    public function up()
    {
        ...
        $this->forge->addKey('id_group_permission', true); // Se define la llave primaria
